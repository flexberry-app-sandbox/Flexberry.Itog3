...
namespace IIS.Itog3
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog3.DetailArrayOfОказУслуг fОказУсл;
        ...
        public virtual IIS.Itog3.DetailArrayOfОказУслуг ОказУсл
        {
            get
            {
                ...
                {
                    this.fОказУсл = new IIS.Itog3.DetailArrayOfОказУслуг(this);
                }
                IIS.Itog3.DetailArrayOfОказУслуг result = this.fОказУсл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Itog3.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Itog3.РасчетОстВрем));
                }
            }
        }
    }
