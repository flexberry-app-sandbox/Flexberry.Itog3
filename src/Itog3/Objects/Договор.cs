...
namespace IIS.Itog3
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog3.Статус fСтатус;
        
        private IIS.Itog3.ТипДоговора fТип;
        
        private int fДлительность;
        
        private int fСтоимость;
        
        private IIS.Itog3.Клиент fКлиент;
        
        private IIS.Itog3.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Itog3.Статус Статус
        {
            get
            {
                ...
                IIS.Itog3.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog3.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog3.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog3.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog3.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog3.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog3.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog3.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog3.Договор));
                }
            }
        }
    }
